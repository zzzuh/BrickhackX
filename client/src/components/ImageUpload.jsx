    ...
    return (
        <div className="flex items-center justify-center w-full">
            <div className="flex items-center justify-center w-4/12">
                <label class=" flex flex-col items-center justify-center w-full h-64 border-2 border-gray-300 border-dashed rounded-xl cursor-pointer bg-dropbox-green hover:bg-hover-green">
                    <div className="flex flex-col items-center justify-center pt-5 pb-6 px-3 ">
                        ...
                        <p className="mb-2 text-gray-500 dark:text-gray-400">
                            <span class="font-semibold 2xl:text-base text-sm">
